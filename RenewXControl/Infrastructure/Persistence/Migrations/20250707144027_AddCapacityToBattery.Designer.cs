...
namespace RenewXControl.Migrations
{
    ...
    [Migration("20250707144027_AddCapacityToBattery")]
    partial class AddCapacityToBattery
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RenewXControl.Domain.Assets.Site", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("RenewXControl.Domain.User", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("RenewXControl.Domain.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("RenewXControl.Domain.Assets.Asset", b =>
                {
                    b.HasOne("RenewXControl.Domain.Assets.Site", "Site")
                        .WithMany("Assets")
            ...
            modelBuilder.Entity("RenewXControl.Domain.Assets.Site", b =>
                {
                    b.HasOne("RenewXControl.Domain.User", "User")
                        .WithMany("Sites")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
